...
exports.uploadTourImages = upload.fields([
  ...
  { name: 'images', maxCount: 3 }  // maximum of 3 images can be uploaded per tour
])
...
exports.getMonthlyPlan = catchAsync(async (req, res, next) => { 
  ...
  exports.getToursWithin  = catchAsync(async (req, res, next) => {
    ...
    const radius = unit ==='mi'? distance / 3963.2 : distance / 6378.1; // radius in miles or kilometers
